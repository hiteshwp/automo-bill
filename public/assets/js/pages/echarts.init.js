...
var posList,
    ...
    (chartBarColors &&
        ...
        myChart.setOption(option), {}),
    chartBarLabelRotationColors = getChartColorsArray("sales-report-chart-bar"),
    chartBarHorizontalColors =
    (chartBarLabelRotationColors &&
        ((chartDom = document.getElementById("sales-report-chart-bar")),
            (myChart = echarts.init(chartDom)),
            (app.configParameters = {
                ...
                position: {
                    options: (posList = ["left", "right", "top", "bottom", "inside", "insideTop", "insideLeft", "insideRight", "insideBottom", "insideTopLeft", "insideTopRight", "insideBottomLeft", "insideBottomRight"]).reduce(function(
                        t,
                        e
                    ) {
                        return (t[e] = e), t;
            ...
            (option = {
                ...
                legend: {
                    data: ["Card", "Invoices", "Cash", "Paypal"],
                    textStyle: {
                        color: "#858d98"
                    }
                },
    ...
    (chartFunnelColors &&
        ...
        myChart.setOption(option),
        /*Gauge chart start*/
        getChartColorsArray("chart-allbooking")),
        chartHeatmapColors =
        (chartGaugeColors &&
        ...
        /*Gauge chart start*/
        getChartColorsArray("chart-repairorder")),
        chartHeatmapColors =
        (chartGaugeColors &&
        ...
        /*Gauge chart start*/
        getChartColorsArray("chart-outstandinginvoice")),
        chartHeatmapColors =
        (chartGaugeColors &&
            ((chartDom = document.getElementById("chart-outstandinginvoice")),
                (myChart = echarts.init(chartDom)),
                (option = {
                    tooltip: {
                        formatter: "{a} <br/>{b} : {c}%"
        ...
        /*Gauge chart start*/
        getChartColorsArray("chart-paidinvoice")),
        chartHeatmapColors =
        (chartGaugeColors &&
            ((chartDom = document.getElementById("chart-paidinvoice")),
                (myChart = echarts.init(chartDom)),
                (option = {
                    tooltip: {
                        formatter: "{a} <br/>{b} : {c}%"
        ...
        /*Gauge chart start*/
        getChartColorsArray("chart-featurebooking")),
        chartHeatmapColors =
        (chartGaugeColors &&
            ((chartDom = document.getElementById("chart-featurebooking")),
                (myChart = echarts.init(chartDom)),
                (option = {
                    tooltip: {
                        formatter: "{a} <br/>{b} : {c}%"
