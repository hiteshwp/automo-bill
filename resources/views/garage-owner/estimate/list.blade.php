            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Estimate List</h4>
                    </div>

                    <div class="card-body">
                        <div class="table-block table-responsive">
                            <table id="garageOwnersEstimateTable" class="table table-hover table-bordered w-100" data-route="{{ route('garage-owner.estimate.data') }}">
                                <thead>
                                    <tr>
                                        <th>Sr No.</th>
                                        <th>Booking ID</th>
