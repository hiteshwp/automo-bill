        ...
        <div class="offcanvasFormBlock">
            <form class="form-fields-block needs-validation" id="frmaddnewinformation" method="post">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="formgroup mb-3">
                            <label class="form-label" for="txtclientname">Company Name*</label>
                            <input type="text" class="form-control" id="txtcompanyname" name="txtclientname" required placeholder="Enter your name" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="formgroup mb-3">
