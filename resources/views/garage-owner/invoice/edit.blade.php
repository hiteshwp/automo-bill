                ...
                <div class="card">
                    <div class="card-body">
                        <div class="page-title-box p-0 d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 d-flex align-items-center gap-2"><a href="{{ route('garage-owner.repair-order.list') }}" class="btn btn-soft-primary btn-icon shadow-none"><i class="ri-arrow-left-line"></i></a> Update Invoice - <span class="fs-14 fw-normal">({{ $invoice_data->client_name }})</span></h4>
                            <div class="page-title-action-list d-flex gap-2">
                                <div class="page-title-action-item">
                                    <a href="{{ route('garage-owner.repair-order.list') }}" class="btn btn-primary btn-select2"><i class="ri-add-large-line"></i> Update Invoice</a>
                                </div>
                                <div class="page-title-action-item">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-8 col-lg-9">
                                <form method="post" id="frmeditinvoiceinformation">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="formgroup mb-3 custom-width1">
                                                        <input type="text" class="form-control" data-provider="flatpickr" name="txtestimatedate" data-date-format="Y-m-d" placeholder="Select date" value="{{ $invoice_data->invoice_date }}" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="invoice-user-info-list py-4">
                                        <div class="invoice-user-info-item">
                                            ...
                                            <h5 class="fs-14 mb-0"><span id="address">{{ $invoice_data->invoice_customer_id }}</span></h5>
                                        </div>
                                        <div class="invoice-user-info-item">
                                            <p class="text-muted mb-2 text-uppercase fw-semibold">Name</p>
                                            <h5 class="fs-14 mb-0"><span id="name">{{ $invoice_data->client_name }}</span></h5>
                                        </div>
                                        <div class="invoice-user-info-item">
                                            <p class="text-muted mb-2 text-uppercase fw-semibold">Address</p>
                                            <h5 class="fs-14 mb-0"><span id="address">{{ $invoice_data->address }}</span></h5>
                                        </div>
                                        <div class="invoice-user-info-item">
                                            <p class="text-muted mb-2 text-uppercase fw-semibold">VIN</p>
                                            <h5 class="fs-14 mb-0"><span id="vin">{{ $invoice_data->vin }}</span></h5>
                                        </div>
                                        <div class="invoice-user-info-item">
                                            <p class="text-muted mb-2 text-uppercase fw-semibold">Vehicle</p>
                                            <h5 class="fs-14 mb-0"><span id="vehicle">{{ $invoice_data->vehicle }}</span></h5>
                                        </div>
                                    </div>
                                    <div class="invoice-form-block">
                                        ...
                                        <div class="invoice-note-block mt-4">
                                            <div class="formgroup">
                                                ...
                                                <textarea class="form-control resize-none" rows="5" placeholder="Enter your note" name="txtextranotes">{{ $invoice_data->invoice_notes }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="invoice-total-info py-4 px-0">
                                        <div class="border-top border-top-dashed mt-2">
                                            <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                <tbody>
                                                    <tr>
                                                        <td>Total Labour</td>
                                                        <td class="text-end" id="txttotallabour">${{ $invoice_data->invoice_labor_total }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Total Parts/Materials</td>
                                                        <td class="text-end" id="txttotalpartsmaterials">${{ $invoice_data->invoice_parts_total }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tax</td>
                                                        <td class="text-end" id="txttotaltax"> {{ $invoice_data->invoice_tax }}</td>
                                                    </tr>
                                                    <tr class="border-top border-top-dashed fs-15">
                                                        <th scope="row">Total Due Amount</th>
                                                        <th class="text-end" id="txttotalduewamount">${{ $invoice_data->invoice_total_inctax }}</th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <!--end table-->
                                        ...
                                        <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                                            ...
                                            <input type="hidden" name="txtsumtotaldueamountexcepttax" id="txtsumtotaldueamountexcepttax" value="{{ $invoice_data->invoice_total }}"/>
                                            <input type="hidden" name="txtsumtotaldueamount" id="txtsumtotaldueamount" value="{{ $invoice_data->invoice_total_inctax }}"/>
                                            <input type="hidden" name="txtrepairorderid" id="txtrepairorderid" value="{{ $invoice_data->invoice_repairorder_id }}"/>
                                            <input type="hidden" name="txtbookingid" id="txtbookingid" value="{{ $invoice_data->invoice_booking_id }}"/>
                                            <input type="hidden" name="txtcustomerid" id="txtcustomerid" value="{{ $invoice_data->invoice_customer_id }}"/>
