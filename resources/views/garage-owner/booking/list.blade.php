                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-block table-responsive">
                            <table id="garageOwnersBookingTable" class="table table-hover table-bordered w-100" data-route="{{ route('garage-owner.booking.data') }}">
                                <thead>
                                    <tr>
                                        <th>Sr No.</th>
...
<div class="offcanvas offcanvas-end offcanvas-width-50" tabindex="-1" id="sidebarNewBooking" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        <div class="offcanvasFormBlock">
            <form class="form-fields-block needs-validation" id="frmaddnewbookinginformation" method="post">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="formgroup mb-3">
                            <label class="form-label">Vehicle*</label>
                            <select class="common-select2" name="txtbookingvehicle" id="txtbookingvehicle" required>
                                ...
                                <option value="{{ $vehiclelist->id }}" data-customerid={{ $vehiclelist->customer_id }}>
                                    {{ $vehiclelist->modelbrand }} {{ $vehiclelist->modelname }} ( {{ $vehiclelist->name }} )
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="formgroup mb-3">
                            <label class="form-label" for="txtbookingclientname">Client*</label>
                            <input type="text" class="form-control" id="txtbookingclientname" name="txtbookingclientname" required placeholder="Enter client" readonly />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="formgroup mb-3">
                ...
                <div class="form-action-block">
                    <div class="form-action-btn">
                        <button type="submit" class="btn btn-primary" id="btnaddnewbooking">Submit</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="offcanvas" aria-label="Close">Cancel</button>
                        <input type="hidden" name="txtbookinguserid" id="txtbookinguserid" value=""/>
...
<div class="offcanvas offcanvas-end offcanvas-width-50" tabindex="-1" id="sidebarEditBooking" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        <div class="offcanvasFormBlock">
            <form class="form-fields-block needs-validation" id="frmupdatebookinginformation" method="post">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="formgroup mb-3">
                            <label class="form-label">Vehicle*</label>
                            <select class="common-select2" name="txtupdatebookingvehicle" id="txtupdatebookingvehicle" required>
                                <option value="" data-customerid="">Select Vehicle</option>
                                @foreach($vehicle_list as $vehiclelist)
                                <option value="{{ $vehiclelist->id }}" data-customerid={{ $vehiclelist->customer_id }}>
                                    {{ $vehiclelist->modelbrand }} {{ $vehiclelist->modelname }} ( {{ $vehiclelist->name }} )
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="formgroup mb-3">
                            <label class="form-label" for="txtupdatebookingclientname">Client*</label>
                            <input type="text" class="form-control" id="txtupdatebookingclientname" name="txtupdatebookingclientname" required placeholder="Enter client" readonly />
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="formgroup mb-3">
                            <label class="form-label">Date & Time*</label>
                            <input type="text" class="form-control datetimeformat" id="ttxtupdatebookingdatetime" name="ttxtupdatebookingdatetime" data-provider="flatpickr" data-date-format="d.m.y" data-enable-time placeholder="Enter date" readonly required />
                        </div>
                    </div>
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="formgroup mb-3">
                ...
                <div class="form-action-block">
                    <div class="form-action-btn">
                        <button type="submit" class="btn btn-primary" id="btnupdatebooking">Update</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="offcanvas" aria-label="Close">Cancel</button>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="removebookingNotificationModal" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
