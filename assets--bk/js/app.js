!function() {
    var e, t, a = document.querySelector(".navbar-menu").innerHTML,
    ...
    function s() {
        var e;
        document.querySelectorAll(".navbar-nav .collapse") && Array.from(e = document.querySelectorAll(".navbar-nav .collapse")).forEach(function(e) {
            var t = new bootstrap.Collapse(e, {
                toggle: !1
            });
            e.addEventListener("show.bs.collapse", function(a) {
                a.stopPropagation(),
                (a = e.parentElement.closest(".collapse")) ? Array.from(a = a.querySelectorAll(".collapse")).forEach(function(e) {
                    ...
                    Array.from(e = e.querySelectorAll("*[id]")).forEach(function(e) {
                        ...
                        2 < e.childNodes.length && Array.from(e = e.querySelectorAll("ul li a")).forEach(function(e) {
    ...
    function d() {
        var e, t = document.documentElement.getAttribute("data-layout"),
        n = sessionStorage.getItem("defaultAttribute"); ! (n = JSON.parse(n)) || "twocolumn" != t && "twocolumn" != n["data-layout"] || (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = a), (e = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="assets/images/logo-sm.png" alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function(t) {
        ...
        }), (t = (t = "/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(t.lastIndexOf("/") + 1)) && (n = document.getElementById("navbar-nav").querySelector('[href="' + t + '"]')) && (t = n.closest(".collapse.menu-dropdown")) && (t.classList.add("show"), t.parentElement.children[0].classList.add("active"), t.parentElement.children[0].setAttribute("aria-expanded", "true"), t.parentElement.closest(".collapse.menu-dropdown")) && (t.parentElement.closest(".collapse").classList.add("show"), t.parentElement.closest(".collapse").previousElementSibling && t.parentElement.closest(".collapse").previousElementSibling.classList.add("active"), t.parentElement.parentElement.parentElement.parentElement.closest(".collapse.menu-dropdown")) && (t.parentElement.parentElement.parentElement.parentElement.closest(".collapse").classList.add("show"), t.parentElement.parentElement.parentElement.parentElement.closest(".collapse").previousElementSibling) && t.parentElement.parentElement.parentElement.parentElement.closest(".collapse").previousElementSibling.classList.add("active"), document.getElementById("two-column-menu").innerHTML = e.outerHTML, Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(function(e) {
            ...
            e.addEventListener("click", function(a) {
                ...
                (a.target && a.target.matches("a.nav-icon") || a.target && a.target.matches("i")) && (null !== document.querySelector("#two-column-menu ul .nav-icon.active") && document.querySelector("#two-column-menu ul .nav-icon.active").classList.remove("active"), (a.target.matches("i") ? a.target.closest("a") : a.target).classList.add("active"), 0 < (n = document.getElementsByClassName("twocolumn-item-show")).length && n[0].classList.remove("twocolumn-item-show"), n = (a.target.matches("i") ? a.target.closest("a") : a.target).getAttribute("href").slice(1), document.getElementById(n)) && document.getElementById(n).parentElement.classList.add("twocolumn-item-show")
            }),
        ...
        }), "horizontal" !== document.documentElement.getAttribute("data-layout") && ((n = new SimpleBar(document.getElementById("navbar-nav"))).getContentElement(), t = new SimpleBar(document.getElementsByClassName("twocolumn-iconview")[0])) && t.getContentElement())
    }
    function o(e) {
        if (e) {
            var t = e.offsetTop,
    ...
    function r() {
        "vertical" != document.documentElement.getAttribute("data-layout") && "semibox" != document.documentElement.getAttribute("data-layout") || (document.getElementById("two-column-menu").innerHTML = "", document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = a), document.getElementById("scrollbar").setAttribute("data-simplebar", ""), document.getElementById("navbar-nav").setAttribute("data-simplebar", ""), document.getElementById("scrollbar").classList.add("h-100")),
    ...
    function m() {
        feather.replace();
        var e = ((e = document.documentElement.clientWidth) < 1025 && 767 < e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), d(), u(), s()), "vertical" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), "semibox" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open")) : 1025 <= e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), d(), u(), s()), "vertical" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")), "semibox" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open")) : e <= 767 && (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s()), "horizontal" != sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon")) && document.querySelector(".hamburger-icon").classList.add("open"), document.querySelectorAll("#navbar-nav > li.nav-item"));
    ...
    function c(e) {
        if (e.target && e.target.matches("a.nav-link span")) {
            ...
            if (1 == o(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth) for (var a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;) a[0].classList.remove("dropdown-custom-right")
        }
        if (e.target && e.target.matches("a.nav-link")) {
            if (0 == o(e.target.nextElementSibling)) e.target.nextElementSibling.classList.add("dropdown-custom-right"),
            ...
            if (1 == o(e.target.nextElementSibling) && 1848 <= window.innerWidth) for (a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;) a[0].classList.remove("dropdown-custom-right")
        }
    }
    function u() {
        feather.replace();
    ...
    function b() {
        ...
        Array.from(e).forEach(function(a, l) {
            l + 10 === 7 && (n = a),
            10 < l + 1 && (t += a.outerHTML, a.remove()),
            l + 1 === e.length && n.insertAdjacentHTML && n.insertAdjacentHTML("afterend", '<li class="nav-item">						<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">							<i class="ri-indent-decrease"></i> <span data-key="t-more">More</span>						</a>						<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' + t + "</ul></div>					</li>")
        })
    }
    function y(e) {
        "vertical" == e
    ...
    function p(e) {
        if (e == e) {
            ...
            case "enable":
                ...
                (t = document.getElementById("preloader")) && window.addEventListener("load", function() {
                    t.style.opacity = "0",
    ...
    function h() {
        setTimeout(function() {
            ...
            a && 300 < (e = (a = a.querySelector(".nav-item .active")) ? a.offsetTop : 0) && (t = document.getElementsByClassName("app-menu") ? document.getElementsByClassName("app-menu")[0] : "") && t.querySelector(".simplebar-content-wrapper") && setTimeout(function() {
    ...
    var f, v, I, w, A, L, B, k, S, z, $, q, x = new Event("resize");
    function T(e, t) {
        Array.from(document.querySelectorAll("input[name=" + e + "]")).forEach(function(a) {
            ...
            a.addEventListener("change", function() {
                ...
                l(),
                "data-layout-width" == e && "boxed" == a.value ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover"), document.getElementById("sidebar-size-small-hover").checked = !0) : "data-layout-width" == e && "fluid" == a.value && (document.documentElement.setAttribute("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"), document.getElementById("sidebar-size-default").checked = !0),
                "data-layout" == e && ("vertical" == a.value ? (y("vertical"), s(), feather.replace()) : "horizontal" == a.value ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(), y("horizontal"), feather.replace()) : "twocolumn" == a.value ? (y("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), d(), u(), s(), feather.replace()) : "semibox" == a.value && (y("semibox"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), document.documentElement.setAttribute("data-layout-style", "default"), document.getElementById("sidebar-view-default").click(), s(), feather.replace()));
                var t, n = "block";
                "semibox" == document.documentElement.getAttribute("data-layout") && ("hidden" == document.documentElement.getAttribute("data-sidebar-visibility") ? (document.documentElement.removeAttribute("data-sidebar"), document.documentElement.removeAttribute("data-sidebar-image"), document.documentElement.removeAttribute("data-sidebar-size"), n = "none") : (document.documentElement.setAttribute("data-sidebar", sessionStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-sidebar-image", sessionStorage.getItem("data-sidebar-image")), document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")))),
                ...
                "data-preloader" == e && "enable" == a.value ? (document.documentElement.setAttribute("data-preloader", "enable"), (t = document.getElementById("preloader")) && setTimeout(function() {
                    t.style.opacity = "0",
                    t.style.visibility = "hidden"
                },
                1e3), document.getElementById("customizerclose-btn").click()) : "data-preloader" == e && "disable" == a.value && (document.documentElement.setAttribute("data-preloader", "disable"), document.getElementById("customizerclose-btn").click()),
        ...
        document.getElementById("collapseBgGradient") && Array.from(document.querySelectorAll("#collapseBgGradient .form-check input")).forEach(function(e) {
            ...
            document.querySelector("[data-bs-target='#collapseBgGradient']") && document.querySelector("[data-bs-target='#collapseBgGradient']").addEventListener("click", function(e) {
    ...
    function _(e, t, a, n) {
        ...
        n.setAttribute(e, t),
        l && document.getElementById(a).click()
    }
    function C() {
    ...
    sessionStorage.getItem("defaultAttribute") ? ((f = {})["data-layout"] = sessionStorage.getItem("data-layout"), f["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), f["data-bs-theme"] = sessionStorage.getItem("data-bs-theme"), f["data-layout-width"] = sessionStorage.getItem("data-layout-width"), f["data-sidebar"] = sessionStorage.getItem("data-sidebar"), f["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), f["data-layout-position"] = sessionStorage.getItem("data-layout-position"), f["data-layout-style"] = sessionStorage.getItem("data-layout-style"), f["data-topbar"] = sessionStorage.getItem("data-topbar"), f["data-preloader"] = sessionStorage.getItem("data-preloader"), f["data-body-image"] = sessionStorage.getItem("data-body-image"), p(f)) : (z = document.documentElement.attributes, f = {},
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(f)), p(f), (z = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && z.click()),
    d(),
    v = document.getElementById("search-close-options"),
    I = document.getElementById("search-dropdown"),
    (w = document.getElementById("search-options")) && (w.addEventListener("focus", function() {
        0 < w.value.length ? (I.classList.add("show"), v.classList.remove("d-none")) : (I.classList.remove("show"), v.classList.add("d-none"))
    }), w.addEventListener("keyup", function(e) {
        var t, a;
        0 < w.value.length ? (I.classList.add("show"), v.classList.remove("d-none"), t = w.value.toLowerCase(), Array.from(a = document.getElementsByClassName("notify-item")).forEach(function(e) {
            var a, n, l = "";
            e.querySelector("h6") ? (a = e.getElementsByTagName("span")[0].innerText.toLowerCase(), l = (n = e.querySelector("h6").innerText.toLowerCase()).includes(t) ? n : a) : e.getElementsByTagName("span") && (l = e.getElementsByTagName("span")[0].innerText.toLowerCase()),
        ...
        "search-options" !== e.target.getAttribute("id") && (I.classList.remove("show"), v.classList.add("d-none"))
    })),
    ...
    A && L && B && (B.addEventListener("focus", function() {
    ...
    (z = document.querySelector('[data-toggle="fullscreen"]')) && z.addEventListener("click", function(e) {
        e.preventDefault(),
    ...
    (z = document.querySelectorAll(".light-dark-mode")) && z.length && z[0].addEventListener("click", function(e) {
        k.hasAttribute("data-bs-theme") && "dark" == k.getAttribute("data-bs-theme") ? _("data-bs-theme", "light", "layout-mode-light", k) : _("data-bs-theme", "dark", "layout-mode-dark", k),
    ...
    document.getElementById("topnav-hamburger-icon") && document.getElementById("topnav-hamburger-icon").addEventListener("click", function e() {
        ...
        "vertical" === document.documentElement.getAttribute("data-layout") && (t <= 1025 && 767 < t ? (document.body.classList.remove("vertical-sidebar-enable"), "sm" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "") : document.documentElement.setAttribute("data-sidebar-size", "sm")) : 1025 < t ? (document.body.classList.remove("vertical-sidebar-enable"), "lg" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "sm") : document.documentElement.setAttribute("data-sidebar-size", "lg")) : t <= 767 && (document.body.classList.add("vertical-sidebar-enable"), document.documentElement.setAttribute("data-sidebar-size", "lg"))),
        "semibox" === document.documentElement.getAttribute("data-layout") && (767 < t ? "show" == document.documentElement.getAttribute("data-sidebar-visibility") ? "lg" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "sm") : document.documentElement.setAttribute("data-sidebar-size", "lg") : (document.getElementById("sidebar-visibility-show").click(), document.documentElement.setAttribute("data-sidebar-size", document.documentElement.getAttribute("data-sidebar-size"))) : t <= 767 && (document.body.classList.add("vertical-sidebar-enable"), document.documentElement.setAttribute("data-sidebar-size", "lg"))),
    ...
    (q = document.querySelectorAll(".counter-value")) && Array.from(q).forEach(function(e) { ! function t() {
            var a = +e.getAttribute("data-target"),
            n = +e.innerText,
            l = a / 250;
            l < 1 && (l = 1),
            n < a ? (e.innerText = (n + l).toFixed(0), setTimeout(t, 1)) : e.innerText = M(a),
            M(e.innerText)
        } ()
    }),
    r(),
    document.getElementsByClassName("dropdown-item-cart") && (S = document.querySelectorAll(".dropdown-item-cart").length, Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function(e) {
        e.addEventListener("click", function(e) {
            S--,
            ...
            F(),
            document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == S ? "block" : "none"),
            document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == S ? "none" : "block")
        })
    }), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function(e) {
        e.innerHTML = S
    }), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = "block"), F()),
    document.getElementsByClassName("notification-check") && (N(), Array.from(document.querySelectorAll(".notification-check input")).forEach(function(e) {
    ...
    Array.from(z = document.querySelectorAll("[data-toast]")).forEach(function(e) {
        e.addEventListener("click", function() {
            var t = {},
            a = e.attributes;
    ...
    Array.from(z = document.querySelectorAll("[data-choices]")).forEach(function(e) {
        var t = {},
        a = e.attributes;
    ...
    Array.from(z = document.querySelectorAll("[data-provider]")).forEach(function(e) {
        var t, a, n;
